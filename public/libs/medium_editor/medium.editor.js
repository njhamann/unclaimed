    ...
    MediumEditor.prototype = {
        ...
        toolbarTemplate: function () {
            return '<ul id="medium-editor-toolbar-actions" class="medium-editor-toolbar-actions clearfix">' +
                   '    <li><a href="#" class="first medium-editor-action medium-editor-action-bold" data-action="bold" data-element="b">B</a></li>' +
                   ...
                   '    <li><a href="#" class="medium-editor-action medium-editor-action-header1" data-action="formatBlock" data-element="' + this.options.firstHeader + '">h1</a></li>' +
                   '    <li><a href="#" class="medium-editor-action medium-editor-action-header2" data-action="formatBlock" data-element="' + this.options.secondHeader + '">h2</a></li>' +
                   '    <li><a href="#" class="last medium-editor-action medium-editor-action-quote" data-action="formatBlock" data-element="blockquote">&ldquo;</a></li>' +
                   '</ul>' +
        ...
        execAction: function(action, e) {
            if (action === 'formatBlock') {
                if (e.target.className.indexOf('medium-editor-button-active') > -1) { 
                    document.execCommand('formatBlock', null, e.target.getAttribute('data-element'));
                }else{
